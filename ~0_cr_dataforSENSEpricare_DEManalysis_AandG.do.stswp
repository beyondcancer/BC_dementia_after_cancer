...
use "$datafiles_an_dem/cr_dataforSENSEpricareDEManalysis_Gold.dta", replace
append using  "$datafiles_an_dem/cr_dataforSENSEpricareDEManalysis_Aurum.dta"
tab exposed
recode eth5_cprd 5=.
...
use	"$datafiles_an_dem/cr_dataforSENSEpricareDEManalysis_AandG.dta", clear
keep if cancer=="`site'"
...
tab maxex
drop if max==0
save "$datafiles_an_dem/cr_dataforSENSEpricareDEManalysis_AandG_`site'.dta", replace
}
