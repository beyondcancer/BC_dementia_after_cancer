...
*/
	...
	*drop if model=="adjusted"
	...
	/// graph options
			...
			xlab(1 2 3 4, labsize(tiny)) /// x-axis tick marks
			xscale(range(1 4) log)						///	resize x-axis
...
/***MAIN FIGURE - A TO D
grc1leg anxiety_0 depression_0 selfharm_0 suicide_0 , ///
iscale(*0.9) cols(2) rows(2) ///
legendfrom(anxiety_0) position(7) ///
...
graph display combined, ysize(4) margins(tiny)  /*8.4 = close to aspect ratio of A4 paper*/
graph export "$results_an_dem/an_Primary_A1_fiveyrsurv_1AtoD_AandG_0.emf", replace
graph export "$results_an_dem/an_Primary_A1_fiveyrsurv_1AtoD_AandG_0.pdf", replace
