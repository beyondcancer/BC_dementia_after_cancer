...
cap drop dementia
if "`outcome'"=="alz" {
gen dementia= 1 if main`year'_datedementia<= doexit & dem_typedementia==1   
}

if "`outcome'"=="vasc" {
gen dementia= 1 if main`year'_datedementia<= doexit & dem_typedementia==2    
}

if "`outcome'"=="other_dem" {
gen dementia= 1 if main`year'_datedementia<= doexit & (dem_typedementia==2  | dem_typedementia==3 | dem_typedementia==4 | dem_typedementia==5 | dem_typedementia==6)      
}

if "`outcome'"=="ns_dem" {
gen dementia= 1 if main`year'_datedementia<= doexit & dem_typedementia==7      
}
