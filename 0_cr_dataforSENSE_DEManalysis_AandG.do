...
use "$datafiles_an_dem/cr_dataforSENSE_DEManalysis_aurum.dta", replace
...
use	"$datafiles_an_dem/cr_dataforSENSE_DEManalysis_AandG.dta", clear
keep if cancer=="`site'"
...
tab maxex
drop if max==0
save "$datafiles_an_dem/cr_dataforSENSE_DEManalysis_AandG_`site'.dta", replace
}
