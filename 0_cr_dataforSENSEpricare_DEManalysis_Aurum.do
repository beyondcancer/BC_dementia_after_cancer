...
use  "$datafiles_core/cr_coredataset_aurum.dta", clear
	...
	merge 1:1 setid e_patid using "$datafiles_raw/cr_listpatid_dementia_pricare_outcome_categories_aurum"
	drop _m
...
* SAVA DATASET
save "$datafiles_an_dem/cr_dataforSENSEpricareDEManalysis_Aurum.dta", replace
