...
cap log close
log using "$logfiles_an_dem/cr_dataforSENSEpricareDEManalysis_Gold.txt", replace t
********************************************************************************
...
use  "$datafiles_core/cr_coredataset_gold.dta", clear
	...
	/* mh outcomes */
	desc using "$datafiles_raw/cr_listpatid_dementia_pricare_outcome_categories_gold"
	merge 1:1 setid e_patid using "$datafiles_raw/cr_listpatid_dementia_pricare_outcome_categories_gold"
...
tab exposed
* SAVA DATASET
save "$datafiles_an_dem/cr_dataforSENSEpricareDEManalysis_Gold.dta", replace
